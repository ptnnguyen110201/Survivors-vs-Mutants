...
public class AvailableSlot : ButtonAbstract
{
    ...
    public virtual void SetAvaiableSlot(CharacterBuyProfile characterBuyProfile)
    {
        ...
        this.button.interactable = !SeedInventory.Instance.IsSelectedSlot(this.characterBuyProfile);
    }
    ...
    {
        SeedInventory.Instance.SelectSeed(this.characterBuyProfile);
    }
